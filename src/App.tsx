    ...
    <>
      <div className='container px-24 mx-auto flex flex-col max-md:px-4'>
        ...
        <div className='flex flex-wrap justify-center gap-10'>
          ...
          <Homecomponent3 imgsrc='/image-4.png' text1='4 Weeks' text2='Beginner' text3='By John Smith' text4='Web Design Fundamentals' text5='Learn the fundamentals of web design, including HTML, CSS, and responsive design principles. Develop the skills to create visually appealing and user-friendly websites.' redirectsrc='/courses' />
          <Homecomponent3 imgsrc='/image-5.png' text1='6 Weeks' text2='Intermediate' text3='By Emily Johnson' text4='UI/UX Design' text5='Master the art of creating intuitive user interfaces (UI) and enhancing user experiences (UX). Learn design principles, wireframing, prototyping, and usability testing techniques.' redirectsrc='/courses' />
          <Homecomponent3 imgsrc='/image-6.png' text1='8 Weeks' text2='Intermediate' text3='By David Brown' text4='Mobile App Development' text5='Dive into the world of mobile app development. Learn to build native iOS and Android applications using industry-leading frameworks like Swift and Kotlin.' redirectsrc='/courses' />
          <Homecomponent3 imgsrc='/image-7.png' text1='10 Weeks' text2='Beginner' text3='By Sarah Thompson' text4='Graphic Design for Beginners' text5='Discover the fundamentals of graphic design, including typography, color theory, layout design, and image manipulation techniques. Create visually stunning designs for print and digital media.' redirectsrc='/courses' />
          <Homecomponent3 imgsrc='/image-8.png' text1='10 Weeks' text2='Intermediate' text3='By Michael Adams' text4='Front-End Web Development' text5='Become proficient in front-end web development. Learn HTML, CSS, JavaScript, and popular frameworks like Bootstrap and React. Build interactive and responsive websites.' redirectsrc='/courses' />
